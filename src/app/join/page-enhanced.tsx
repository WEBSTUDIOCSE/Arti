                          ...
                          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-3 border border-amber-200">
                            <div className="flex items-center gap-2 mb-2">
                              <Badge variant="outline" className="text-xs bg-amber-100 text-amber-800 border-amber-300">
                                {preview.aarti.deity.charAt(0).toUpperCase() + preview.aarti.deity.slice(1)}
                              </Badge>
                            ...
                            <div className="flex items-center justify-between mt-2 text-xs text-gray-500">
                              ...
                              <Badge 
                                variant="outline"
                                className={`text-xs ${
                                  preview.aarti.difficulty === 'easy' ? 'bg-green-50 text-green-700' :
                                  preview.aarti.difficulty === 'medium' ? 'bg-yellow-50 text-yellow-700' :
                                  'bg-red-50 text-red-700'
                                }`}
                              >
                                {preview.aarti.difficulty}
                              </Badge>
                            </div>
                          </div>
                        )}
